...
class JobInfoApp(QMainWindow):
    ...
    def create_resume(self):
        ...
        with open(".github/output/resume.md", "w") as file:
            file.write(resume_text)

        with open(".github/output/coverletter.md", "w") as file:
        ...
        convert_md_to_pdf(".github/output/resume.md", ".github/output/generated_resume.pdf")
        convert_md_to_pdf(".github/output/coverletter.md", ".github/output/generated_coverletter.pdf")
